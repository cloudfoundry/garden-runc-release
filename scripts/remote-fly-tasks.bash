...
export run_guardian_nerdful="echo 'yes' | CONTAINERD_ENABLED=true CONTAINERD_FOR_PROCESSES_ENABLED=true ./scripts/remote-fly ci/guardian/task.yml -i tar-out=${TAR_OUT}"
export run_guardian_throttled="echo 'yes' | CONTAINERD_ENABLED=true CPU_THROTTLING_ENABLED=true ./scripts/remote-fly ci/guardian/task.yml -i tar-out=${TAR_OUT}"
