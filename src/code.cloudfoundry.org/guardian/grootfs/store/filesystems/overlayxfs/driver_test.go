...
import (
	...
	"code.cloudfoundry.org/guardian/grootfs/store/filesystems"
	"code.cloudfoundry.org/guardian/grootfs/store/filesystems/overlayxfs"
	fakes "code.cloudfoundry.org/guardian/grootfs/store/filesystems/overlayxfs/overlayxfsfakes"
...
var _ = Describe("Driver", func() {
	...
	Describe("FetchStats", func() {
		...
		Context("when it fails to fetch XFS project ID", func() {
			It("returns an error", func() {
				_, err := driver.FetchStats(logger, "/proc")
